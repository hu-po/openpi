...
TABLET_CANVAS_SIZE_TABLETSPACE: Tuple[int, int] = (80, 80)  # size of canvas in tablet coordinates
TABLET_CANVAS_SIZE_PIXELSPACE: Tuple[int, int] = (80, 80)  # size of canvas in pixel space
